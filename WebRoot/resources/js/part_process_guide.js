	      ...
	      function cbBack(){
	    	  ...
	    	  var subsidiaryMaterialCost=document.getElementById("myform:subsidiaryMaterialCost").value;
	     ...
	     function menuClick(id){
	    	  var arr=new Array("jbxx","jt","wl","zy","cb","zj");
	    	  for(var i=0;i<arr.length;i++){
	    		  if(arr[i]==id){
	    			  document.getElementById(arr[i]).style.display="block";
	    			  document.getElementById("xs"+arr[i]).style.backgroundColor="#666666";
	    			  document.getElementById("xs"+arr[i]).style.color="white";
	    		  }else{
	    			  document.getElementById(arr[i]).style.display="none";
	    			  document.getElementById("xs"+arr[i]).style.backgroundColor="";
	    			  document.getElementById("xs"+arr[i]).style.color="";
	    		  }
	    	  }
	     ...
	     function of(){
	      ...
	      document.getElementById("tree").onmouseout=function(event){
