 ...
 * @version V1.0
 */
public class ErpMaterialDataModel extends ListDataModel<Map<String,Object>> implements SelectableDataModel<Map<String,Object>>{
	
	public ErpMaterialDataModel() {  
		
    }  
  
    public ErpMaterialDataModel(List<Map<String,Object>> data) {  
        super(data);  
    }  
