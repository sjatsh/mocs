...
@ManagedBean(name="monthPlanBean")
...
public class MonthPlanBean implements Serializable{
	...
	public MonthPlanBean(){
		...
		this.setTotalTableHeadData(testService.getTotalTableHeadData("planNum", "planEndtime",searchTime));//获取分厂总的表头信息
		this.setPartClassAndHeadData(testService.getPartClassAndHeadData("planNum", "planEndtime",searchTime));//获取大类表头信息集合
	...
	public List<Map<String, Object>> getTypeData() {
		...
		return testService.getTypeData("planNum", "planEndtime",searchTime, partClass);
	}
